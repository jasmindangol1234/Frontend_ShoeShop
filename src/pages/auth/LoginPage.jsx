...
function LoginPage() {
  ...
  const MOCK_USER = {
    id: "mock-user-001",
    email: "jasmindangol135@gmail.com",
    password: "jasmin123",
    role: "user",
    name: "Jasmin Dangol",
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white p-6 sm:p-8 rounded-md shadow-md border border-blue-400">
        <h2 className="text-2xl font-bold text-center text-background mb-2">
          Login
        </h2>
        <p className="text-sm text-background text-center mb-6">
        ...
        <form onSubmit={handleLogin}>
          ...
          {error && (
            <p className="text-sm text-red-600 text-center my-3">{error}</p>
          )}
