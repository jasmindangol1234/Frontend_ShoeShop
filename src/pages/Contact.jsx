...
import Car from "../assets/images/contact/car.png";
    ...
    <div className="container text-background mt-36">
      ...
      <div className="flex flex-col md:flex-row text-center justify-center mt-4 md:mt-6 mb-10 ">
        <div className="flex justify-center items-start flex-col gap-4 md:w-2/3 md:px-10">
          <h1 className="text-2xl font-semibold md:font-bold md:text-4xl px-4 text-background">
            Information About Us
          </h1>
          <p className="text-justify p-4 md:w-[95%] text-background">
            At SoleCraft, we believe the right pair of shoes can change how you
            move, feel, and express yourself. Our goal is to deliver footwear
            that blends comfort, durability, and modern style for every step of
            your journey. From everyday casual wear to performance-ready
            sneakers, we design shoes that fit your lifestyle perfectly. We
            focus on quality materials, precise craftsmanship, and trend-driven
            designs to ensure every pair lasts longer and looks better. At
            SoleCraft, shoes are not just accessories — they are a statement of
            confidence and comfort.
          </p>

          <img
            src={Warehouse}
            alt="main logo warehouse"
        ...
        <div className="flex justify-start items-center flex-col gap-4">
          ...
          <section className="mt-14 mb-10 flex flex-col items-center text-center gap-6 px-6">
            ...
            <p className="max-w-2xl text-justify items-start py-4  text-background ">
              At SoleCraft, we combine innovative design, premium materials, and
              everyday comfort to create shoes you’ll love wearing. Our footwear
              is crafted to support your feet while keeping you stylish in every
              situation. We are committed to reliable quality, affordable
              pricing, and customer-first service. Whether you’re walking,
              running, or heading out in style, SoleCraft ensures every step
              feels confident, comfortable, and effortless.
            </p>
          </section>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-8">
            <div>
              ...
              <p className="text-background text-left max-w-xl">
                ...
                sizing, delivery, or product details, our team is always ready
                to help. Reach out anytime — we’re here to make your shoe
                shopping smooth and satisfying.
              </p>
            </div>
